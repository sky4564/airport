      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="/board" className="text-gray-900 hover:text-blue-700 px-3 py-2 rounded-md text-sm font-semibold transition-colors duration-200">공지사항</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/board" className="text-gray-900 hover:text-blue-700 block px-3 py-2 rounded-md text-base font-semibold transition-colors duration-200" onClick={() => setIsMenuOpen(false)}>공지사항</Link>
